...
public class MenuPrincipal extends JFrame implements ActionListener {
	...
	public MenuPrincipal() {
		...
		mMedecins.add(mC2);
		JMenuItem mC3 = new JMenuItem("Rapport Visite Medecins");
		mC3.addActionListener(this);
		mMedecins.add(mC3);

		mMedicaments = new JMenu("Medicaments");
		JMenuItem mE1 = new JMenuItem("Liste Medicament");
	...
	public void actionPerformed(ActionEvent evt) {
		...
		if (evt.getSource() instanceof JMenuItem) {
			...
			} else if (ChoixOption.equals("Rapport Visite Medecins")) {
				ouvrirFenetre(new JIFMedecinRapportVisite());
			}
	...
	public void ouvrirFenetre(JInternalFrame uneFenetre) {
		...
		myJInternalFrame.setSize(600, 400);
		
		Dimension desktopSize = desktopPane.getSize();
		Dimension jInternalFrameSize = myJInternalFrame.getSize();
		myJInternalFrame.setLocation((desktopSize.width - jInternalFrameSize.width)/2, 0);

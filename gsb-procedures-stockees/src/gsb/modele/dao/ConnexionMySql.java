...
public class ConnexionMySql { // DAO = Data Access Object
	 ...
	 */
	public static void connecterBdMysql(){
		
		//connexion à la base de donnée à partir de jdbc
		// adresse serveur 192.174.1.13 
		// nom de la base javaGsb
		// login : admindb
		// password : password
		String url = "jdbc:mysql://127.0.0.1:3306/javagsb"; // url : chaine de connexion
	...
	public static void connecterBd(){
		...
		// login : admindb
		// password : password
		String url = "jdbc:oracle:thin:@192.168.56.101:1521:oracle";
		String user = "JAVA_GSB";
